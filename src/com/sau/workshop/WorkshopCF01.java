...
public class WorkshopCF01 {
    ...
    //กรณีเลือก 1 คำนวณพื้นที่สี่เหลี่ม ป้อนกว้าง ยาว คำนวณ แสดงผล (กว้าง * ยาว)
    //กรณีเลือก 2 คำนวณพื้นที่สามเหลี่ม ป้อนฐาน สูง คำนวณ แสดงผล (ฐาน * สูง / 2)
    //กรณีเลือก 3 คำนวณพื้นที่วงกลม ป้อนรัศมี คำนวณ แสดงผล (PI * รัศมี²)
